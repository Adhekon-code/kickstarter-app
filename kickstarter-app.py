...
all_features = ['Goal', 'Category', 'Country', 'Name']
...
data = pd.read_csv('kickstarter_2016.csv')
X = data[selected_features]  # Ensure 'data' is defined before this line
y = data['State']  # Ensure 'Success' column exists in your data

# Dynamically determine numeric and categorical features based on selection
numeric_features = ['Goal']  # Assuming 'Goal' is numeric
categorical_features = [f for f in selected_features if f in ['Category', 'Country', 'Name']]
